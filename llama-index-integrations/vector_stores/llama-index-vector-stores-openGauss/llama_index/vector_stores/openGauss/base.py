...
class OpenGaussStore(BasePydanticVectorStore):
    ...
    Examples:
        ...
        # Create OpenGaussStore instance
    ...
    def from_params(
        ...
        Args:
            ...
            port (Optional[str], optional): Port of openGauss connection. Defaults to None.
    ...
    async def _async_hybrid_query(
        ...
        if query.alpha is not None:
            _logger.warning("openGauss hybrid search does not support alpha parameter.")
